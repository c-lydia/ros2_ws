...
bool test_custom_msg_srv__msg__sphere__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("test_custom_msg_srv.msg._sphere.Sphere", full_classname_dest, 38) == 0);
  }
  test_custom_msg_srv__msg__Sphere * ros_message = _ros_message;
  {  // center
...
PyObject * test_custom_msg_srv__msg__sphere__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("test_custom_msg_srv.msg._sphere");
