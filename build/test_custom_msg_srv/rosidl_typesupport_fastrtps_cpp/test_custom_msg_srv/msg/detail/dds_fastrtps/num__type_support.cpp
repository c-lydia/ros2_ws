...
#include "test_custom_msg_srv/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const test_custom_msg_srv::msg::Num & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  test_custom_msg_srv::msg::Num & ros_message)
{
  // Member: num
  cdr >> ros_message.num;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = test_custom_msg_srv::msg::Num;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const test_custom_msg_srv::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<test_custom_msg_srv::msg::Num *>(
    untyped_ros_message);
...
get_message_type_support_handle<test_custom_msg_srv::msg::Num>()
{
  return &test_custom_msg_srv::msg::typesupport_fastrtps_cpp::_Num__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, test_custom_msg_srv, msg, Num)() {
  return &test_custom_msg_srv::msg::typesupport_fastrtps_cpp::_Num__handle;
}
