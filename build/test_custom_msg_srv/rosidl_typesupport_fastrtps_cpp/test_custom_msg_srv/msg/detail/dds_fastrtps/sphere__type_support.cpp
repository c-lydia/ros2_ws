...
#include "test_custom_msg_srv/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = test_custom_msg_srv::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const test_custom_msg_srv::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<test_custom_msg_srv::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &test_custom_msg_srv::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
